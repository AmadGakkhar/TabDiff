"""Generate synthetic positive GMSC rows from a trained gmsc_l<N>_inner model.

Same post-processing as gen_gmsc_v2.py (NaN restore / integer round / tail clip),
just targeting the *_inner datasets trained on train_inner.csv.

  python gen_gmsc_inner.py --split <N> --n <COUNT> --gpu <G> --out <PATH>
"""
import os
import json
import time
...
def main():
    ...
    dataname = f"gmsc_l{args.split}_inner"
