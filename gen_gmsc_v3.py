"""Generate synthetic positive GMSC rows from a trained gmsc_l<N>_v3 model.

Same post-processing as gen_gmsc_v2.py (NaN restore / integer round / tail clip),
targeting the *_v3 datasets trained on the new (reduced-positive) train.csv.

  python gen_gmsc_v3.py --split <N> --n <COUNT> --gpu <G> --out <PATH>
"""
import os
import json
import time
...
def main():
    ...
    dataname = f"gmsc_l{args.split}_v3"
